			...
			<div id="main">
				<!-- Header -->
					<header id="header">
						...
						<p>Captin Won &nbsp;&bull;&nbsp; HyeonJoong &nbsp;&bull;&nbsp; YoungMin &nbsp;&bull;&nbsp; JinSu &nbsp;&bull;&nbsp; HaeRin</p>
						<nav>
							<ul>
								...
								<li><a href="#" class="fa fa-user-plus"><span class="label">Register</span></a></li>
								
							</ul>
							
						<form method="post">
							<p>ID <input class="login" type="text"></p>
							<p>PW<input class="login" type="text"></p>
